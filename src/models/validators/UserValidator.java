...
public class UserValidator {
    public static List<String> validate(User u, Boolean name_duplicate_check_flag, Boolean email_duplicate_check_flag, Boolean password_check_flag) {

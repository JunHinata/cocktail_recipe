            ...
            <div class="pagination">
                <c:forEach var="i" begin="1" end="${((ingredients_count - 1) / 30) + 1}" step="1">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <form id="page_transition" method="POST" action="<c:url value='/recipes/ingredient_new' />">
                            ...
                            <button class="page_anchor" type="submit" form="page_transition" name="page" value="${i}"><c:out value="${i}" /></button>&nbsp;
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
            </div>

            <form method="POST" action="<c:url value='/recipes/new' />">

    ...
    <c:param name="content">
        ...
        <div class="window">
                    ...
                    <div id="ingredient">
                        ...
                        <table class="chose_ingredients">
                            <tbody>
                                <tr>
                                    <th>
                                        <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="1">
                                            <c:choose>
                                ...
                                <tr>
                                    <th>
                                        <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="2">
                                            <c:choose>
                                ...
                                <c:if test="${ing1.name != null && ing2.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="3">
                                                <c:choose>
                                ...
                                <c:if test="${ing3.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="4">
                                                <c:choose>
                                ...
                                <c:if test="${ing4.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="5">
                                                <c:choose>
                                ...
                                <c:if test="${ing5.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="6">
                                                <c:choose>
                                ...
                                <c:if test="${ing6.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="7">
                                                <c:choose>
                                ...
                                <c:if test="${ing7.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="8">
                                                <c:choose>
                                ...
                                <c:if test="${ing8.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="9">
                                                <c:choose>
                                ...
                                <c:if test="${ing9.name != null}">
                                    <tr>
                                        <th>
                                            <button class="as_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/ingredient_edit' />" name="ing_number" value="10">
                                                <c:choose>
                                ...
                                <tr>
                                    <th>
                                        <c:if test="${ing3.name != null}">
                                            <button class="as_red_anchor" type="submit" form="edit" formaction="<c:url value='/recipes/edit' />" name="remove_flag" value="1">材料を1つ取消</button>
                                        </c:if>
                                    </th>
                                    <td></td><td></td>
                                </tr>
            ...
            <div class="action_button">
                <a class="gray_button" href="<c:url value='/recipes/show?id=${recipe_id}' />">レシピ詳細に戻る</a>
                <a class="red_button" href="#" onclick="confirmDestroy();">このレシピを削除</a>
                <button class="orange_button" type="submit" form="edit" formaction="<c:url value='/recipes/update' />">このレシピを更新</button>
